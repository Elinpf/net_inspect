...
class BaseInfoExpect:
    ...
    uptime: str = ''
    ip: str = ''
    sn: List[Tuple[str, str]] = field(default_factory=lambda: [])
    cpu_usage: str = ''
    memory_usage: str = ''
...
def test_run_hp_comware_2_base_info(shared_datadir):
    ...
    file_path = shared_datadir / 'base_info_logs' / 'hp_comware_test_memory.txt'
...
# ==================  test manager_ip with vlan ==================


def test_run_cisco_ios_base_info_manager_ip(shared_datadir):
    file_path = shared_datadir / 'base_info_logs' / 'cisco_ios_test_manager_ip.txt'
...
def test_run_huawei_vrp_base_info_manager_ip(shared_datadir):
    """测试在没有loopback0的情况下，选取一个vlan ip作为管理ip"""
    file_path = shared_datadir / 'base_info_logs' / 'huawei_vrp_test_manager_ip.txt'
...
def test_run_hp_comware_base_info_manager_ip(shared_datadir):
    """测试在没有loopback0的情况下，选取一个vlan ip作为管理ip"""
    file_path = shared_datadir / 'base_info_logs' / 'hp_comware_test_manager_ip.txt'
...
def test_run_maipu_mypower_base_info_manager_ip(shared_datadir):
    file_path = shared_datadir / 'base_info_logs' / 'maipu_mypower_test_manager_ip.txt'
...
def test_run_ruijie_os_base_info_manager_ip(shared_datadir):
    file_path = shared_datadir / 'base_info_logs' / 'ruijie_os_test_manager_ip.txt'
